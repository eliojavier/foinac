<%-- 
    Document   : insertarTransaccion
    Created on : 27/03/2016, 03:41:17 AM
    Author     : Elio
--%>
...
<body>
    ...
    <form id="TransaccionForm" class="form-horizontal" action="insertarTransaccion.do" method="post">                         
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="accionista">Operación: </label>
            <div class="col-sm-3">
                <select class="form-control" name="tipoOperacion">
                    <option value="Pago de capital">      Pago de capital</option>
                    <option value="Pago de intereses">    Pago de intereses</option>                   
                    <option value="Prestamo">             Préstamo</option> 
                    <option value="Compra dolares">       Compra dólares </option>
                    <option value="Venta dolares">        Venta dólares </option>
                    <option value="Ganancia venta divisas">Ganancia venta divisas </option>
                    <option value="Intereses banco">      Intereses banco </option>
                </select>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="col-sm-offset-2 col-sm-4">
            <button type="submit" class="btn btn-default">Guardar Transacción</button>
        </div>   
    </form>
    </div>
